							   ...
							   <div class="panel panel-default">
								   <div class="panel-heading">
									   ...
									   <h4 class="panel-title">
										   ...
										   <a data-toggle="collapse" href="#collapse1">Hello ,<?php echo substr($nama,0,3); ?></a>
									   </h4>
								   </div>
								   <div id="collapse1" class="panel-collapse collapse">
									   <form action="#" method="post"></form>
										   ...
										   <a href='../../template log reg/colorlib-regform-26/login.php'><div class="panel-footer">Keluar</div></a>
										   <!-- <a href="login.php"><div class="panel-footer" name="logout" >Keluar</div></a> -->
									   </form>
								   </div>
							   </div>
						   </div>
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-md-12 ftco-animate text-center">
	              ...
	              <p><a href="#" class="btn btn-primary">Lihat menu</a></p>
	            </div>
