...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Berikan review dan rating </p>
        ...
        <div class="row">
          <div class="col-12">
            <button type="button" onclick='review()' class="btn btn-primary btn-block">Review</button>
          </div>
          <!-- /.col -->
        </div>
