    		...
    		<div class="row">
				<?php
					...
					foreach ($query as $key => $value) {
						...
						";echo"		<a href='#' class='img-prod'><img style='background-size: cover;width:255px;height:180px'class='img-fluid' src='../../gambar/image/$value[nama_menu].jpg' alt='Colorlib Template'>
						";echo"			
						";echo"			<div class='overlay'></div>
						";echo"		</a>
						";echo"		<div class='text py-3 pb-4 px-3 text-center'>
						";echo"			<h3><a href='#'>$value[nama_menu]</a></h3>
