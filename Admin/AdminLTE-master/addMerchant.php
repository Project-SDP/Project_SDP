              ...
              <form role="form">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="nama" class="form-control" id="exampleInputEmail1" placeholder="Masukkan nama">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Masukkan no telepon">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Masukkan username">
                  </div>
                  <div class="form-group">
                    <label for="exampleInput">Password</label>
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Masukkan password">
                  </div>
                  <div class="form-group">
                    <label for="example">Konfirmasi Password</label>
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Masukkan konfirmasi password">
                  </div>
                ...
                <div class="card-footer">
                  <input type="submit" class="btn btn-primary" value="Daftar" name="reg">
