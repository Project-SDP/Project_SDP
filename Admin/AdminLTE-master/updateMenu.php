<?php
    ...
    echo     "<input type='number' class='form-control' id='harga' value='$query[harga_menu]' placeholder='Masukkan harga'>";
    echo "</div>";
    echo "<div class='form-group'>";
    ...
    echo "</div>";
    echo "<div class='form-group'>";
    echo  "<label for='exampleInputEmail1'>Merchant</label>";
    echo"<select class='form-control select2' style='width: 100%;'  name='merch' id='merch'> ";
